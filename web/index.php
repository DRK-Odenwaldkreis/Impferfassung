...
<div class="row">
    ...
    <div class="col-sm-6">
        <div style="text-align: center;">
            <h2>Covid-19 Impfzentrum Odenwaldkreis</h2>
    ...
    <div class="col-sm-12">
        ...
        <p>Schreiben Sie uns an <a href="mailto:impfzentrum@drk-odenwaldkreis.de?subject=Fragen - Impfzentrum">impfzentrum@drk-odenwaldkreis.de</a></p>
        </div>
    </div>
</div>
...
<div class="alert alert-info" role="alert">
    ...
    <div class="col-sm-4 col-xs-12 main-link-page" onclick="window.location='registration/business.php'">
        ...
        <h5>**) wenden Sie sich für ein Angebot an das Impfzentrum <a href="mailto:impfzentrum@drk-odenwaldkreis.de">impfzentrum@drk-odenwaldkreis.de</a></h5>
        </div>
        </div>
    </div>
...
if(!$GLOBALS['FLAG_SHUTDOWN_MAIN']) {
    ...
    <p></p>
    <h3>Impfzentrum Reichelsheim </h3>
    <p>Dienstag und Donnerstag                            6-10 Uhr und 16-20 Uhr 
    <br>
    Sonntag                                                              9-19 Uhr 
    </p>
    <p></p>
    <h3>PCR Test im Impfzentrum Erbach </h3>
