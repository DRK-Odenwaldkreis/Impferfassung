...
class PDFgenerator:
	...
	def __init__(self, doses, booster, ages, waiting, vaccine, date):
		self.doses = doses
	...
	def generate(self):
		...
		pdf.set_font('GNU', '', 14)
		self.filename = "../../Reports/Impfzentrum/Forecast_Impfen_" + str(self.vaccine).replace(" ","") + "_" + str(self.date) + ".pdf"
