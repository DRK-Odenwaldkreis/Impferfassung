    ...
    if(isset($_POST['submit_person'])) {
        ...
        if (filter_var($k_email, FILTER_VALIDATE_EMAIL)) {
            ...
            if($prereg_id=='DOUBLE_ENTRY') {
                ...
                $header = "From: no-reply@Impfzentrum-odenwald.de\r\n";
                $header .= "Content-Type: text/plain; charset=UTF-8\nContent-Transfer-Encoding: 8bit";
                $content="Guten Tag,\n
Sie wurden soeben für einen Termin im DRK Impfzentrum Odenwaldkreis eingetragen. Falls diese Anfrage von Ihnen nicht initiiert wurde, können Sie diese Nachricht ignorieren.\n
...
Das Team vom DRK Impfzentrum Odenwaldkreis";
                $title='DRK Covid-19 Impfzentrum Odenwaldkreis - Termin bestätigen';
                $res=mail($k_email, $title, $content, $header, "-r no-reply@Impfzentrum-odenwald.de");
                ...
                <p>Nach Abschluss des Registrierungsprozesses erhalten Sie auf Ihre E-Mail-Adresse einen QR-Code, den Sie bei dem Impfzentrum vorzeigen müssen (gedruckt oder auf dem Display). Bitte halten Sie im Impfzentrum auch einen Lichtbildausweis bereit.</p>
            ...
            <div class="panel panel-primary">
                ...
                <form action="'.$current_site.'.php" method="post">
                    ...
                    if($val_cwa_connection==1 && $pcr_test==0) {
                        ...
                        <div class="alert alert-warning" role="alert">
                                <div class="header_icon">
                                    ...
                                    <h4>Wurde dieser Test angeordnet nach positivem Schnelltest oder aufgrund Kontakt zu einer positiv getesteten Person, so ist die Testung kostenfrei. Bitte bringen Sie dafür eine Bestätigung zum Impfzentrum mit (z. B. ein Schnelltest-Zertifikat mit positivem Ergebnis).</h4>
                                    <h4>Andernfalls fallen für den PCR-Test Gebühren an, die Sie im Impfzentrum entrichten müssen.</h4>
                                    </div>
                                </div>
                    ...
                    <label for="cb2">Ich bestätige die wahrheitsgemäße Angabe der Selbsteinschätzung und der angegebenen Daten. Falls sich an den obigen Antworten bis zum Testzeitpunkt etwas ändert, verpflichte ich mich, dies dem Impfzentrum vor dem Abstrich mitzuteilen.</label>
                    </div>
                    <div class="FAIRsepdown"></div><div class="cb_drk">
