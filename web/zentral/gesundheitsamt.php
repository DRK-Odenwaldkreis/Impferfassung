...
if( A_checkpermission(array(0,0,3,4,0)) ) {
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Print html header
     ...
     echo '<head>
     <title>Positivmeldungen & PCR - DRK Covid-19 Impfzentrum Odenwaldkreis</title>
     <!-- Required meta tags -->
     <meta charset="utf-8">
